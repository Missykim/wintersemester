...
def main():
    ...
    birth_str=(input('What is your birthdate (in this format: YYYY-MM-DD):'))
    pounds=int(input('What is your weight (lbs):'))
    inches=int(input('What is your height (inches):'))
...
def compute_age(birth_str):
    ...
    # If necessary, subtract one from the difference.f
