...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    18.01528
    """
    # Example: symbol_quantity_list = [['Zr',1],['Zn',2],['Yb',3]]
    # - For each inner list in the compound symbol_quantity_list:
    ...
    for inner_list in symbol_quantity_list:
        ...
        dictionary_record=periodic_table_dict[symbol]
        atomic_mass=dictionary_record[1]
        product=atomic_mass*quantity
        total_molar_mass=product+total_molar_mass
    # - Return the total molar mass.
    return total_molar_mass
    
def main():
    # TODO: Code by comments below...
    # - Get a chemical formula for a molecule from the user.
    chemical_formula=input("enter a chemical formula.")
    # - Get the mass of a chemical sample in grams from the user.
    mass=input('Enter in the mass of your sample.')
